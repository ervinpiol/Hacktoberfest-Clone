...
const EventsSvg = () => {
  return (
    <div className="w-[66px] h-[63px] origin-top-right absolute top-10 right-10 scale-[2] flex items-center justify-center filter-shadow">
      <div className="flex items-center justify-start absolute rounded-full overflow-hidden z-[2] h-[96%] w-[96%] container-anim">
        <svg
          className="events-anim"
          width="246"
          height="60"
          viewBox="0 0 246 60"
          fill="none"
        ...
        >
          ...
          <path
            ...
            fill="currentColor"
          ></path>
          <path d="M108 19H111V25H105V22H108V19Z" fill="currentColor"></path>
          <path d="M96 39H99V42H96V39Z" fill="currentColor"></path>
          <path
          ...
          <path
            ...
            fill="currentColor"
          ></path>
          <path d="M102 54V57H99V54H102Z" fill="currentColor"></path>
          <path d="M75 48H78V51H75V48Z" fill="currentColor"></path>
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            ...
            fill="currentColor"
          ></path>
          <path d="M231 19H234V25H228V22H231V19Z" fill="currentColor"></path>
          <path d="M219 39H222V42H219V39Z" fill="currentColor"></path>
          <path
          ...
          <path
            ...
            fill="currentColor"
          ></path>
          <path d="M225 54V57H222V54H225Z" fill="currentColor"></path>
          <path d="M198 48H201V51H198V48Z" fill="currentColor"></path>
        </svg>
      </div>
      <svg
        width="66"
